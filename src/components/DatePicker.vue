<template>
    <div :class="calendarClass">
        <div :class="calendarContainerClass">
            <div :class="data.classes" v-for="(data, dataIdx) in monthsData" :key="'month_data' + dataIdx">
                <div class="calendar-header">
                    <div class="month-name">
                        <template v-if="dataIdx == 0">
                            <span @click="movePrevMonth()" class="prev-icon" v-if="nextPrevIcon"
                        ...
                        <template v-if="(!enableSecondCalendar && dataIdx == 0) || dataIdx == 1">
                            <span @click="moveNextMonth()" class="next-icon" v-if="nextPrevIcon"
                ...
                <div class="calendar-dates">
                    <template v-for="dateRowIdx in data.calendarRows" :key="'date_row_' + dataIdx + dateRowIdx">
                        <div class="date-row">
                            <template v-for="(dt, index) in data.dates.slice(
                                7 * (dateRowIdx - 1),
                                7 * dateRowIdx
                            )">
                                <template v-if="typeof dt === 'object'">
                                    ...
                                    }" :key="'calendar_dates' + dateRowIdx + index" @click="onSelectDate(dt)"
